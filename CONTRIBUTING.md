...
Thanks for your interest in contributing to `common` — Pilot Protocol shared helpers — small, pure-stdlib utilities used across the protocol repo and extracted plugins.

## Quick start

```bash
git clone https://github.com/pilot-protocol/common.git
cd common
go test -race ./...
```
